...
export default function MyPortfolio() {
  ...
  useEffect(() => {
    if (selectedTech === 'all') {
      ...
      setFilteredProjects(projects.filter((p) => p.technologies?.includes(selectedTech)));
    }
      ...
      <div className="container  px-2 md:px-4 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
            Une sélection de mes projets les plus significatifs, alliant design moderne et
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {visibleProjects.map((project) => (
            <PublicProjectCard key={project.id} project={project} featured={project.featured} />
          ))}
        </div>
        ...
        {visibleProjects.length === 0 && (
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-gray-700 mb-2">En chargement...</h3>
            <p className="text-gray-500">Veillez-patientez</p>
          </div>
        )}
        ...
        <div className="flex flex-wrap gap-2 items-center justify-between mt-5">
          {displayCount < filteredProjects.length && (
            <div className="text-center ">
              <button
                onClick={() => setDisplayCount((prev) => prev + filteredProjects.length)}
              ...
              >
                Voir {filteredProjects.length - displayCount} projets supplémentaires
